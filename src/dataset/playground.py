from src.dataset.generate_dataset import load_dataset, generate_dataset
...
greyscale_buffer, rgb_buffer, action_buffer, reward_buffer, done_buffer = load_dataset(path)
